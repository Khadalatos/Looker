...
@section('content')
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            @foreach ($permissions as $permission)
                                <tr data-identifier="{{ $permission->id }}">
                                    <td></td>
                                    ...
                                    <form action="{{ route('admin.permissions.destroy', $permission->id) }}"
                                        method="post" id="destroy-{{ $permission->id }}" style="display: none">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </tr>
    ...
    <form action="{{ route('admin.permissions.bulkDelete') }}" id="deleteSelectedForm" method="POST"
        class="d-none">
        @csrf
        @method('DELETE')
